...
const GlobalSvgSelector = ({id}: Props) => {
  switch (id) {
    case 'header-logo':
      return (<svg xmlns="http://www.w3.org/2000/svg" width="65" height="65" viewBox="0 0 65 65" fill="none">
    ...
    case 'change-theme':
      return (<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
